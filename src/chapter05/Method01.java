...
// : 각 매개변수는 자료형과 함께 선언
//      - 일반 변수 정의처럼 동일한 데이터 타입의 생략이 불가 (int a, b (X) / int a, int b (O) )
//      - 메서드 내부에서 지역 변수로 사용
...
class Calculator {
    ...
    int addNumbers(int a, int b) {
       ...
       return sum;  // return a + b; 도 가능 , return String은 불가 (int형으로 반환되어야 하기 때문)
    }
    ...
    void voidMethod () {
        ...
        return;  // void 타입일 경우, 보통 return; 을 사용하지 않음(권장)
    }
}
...
public class Method01 {
    public static void main(String[] args) {
        ...
        int result = calculator.addNumbers(50, 30);  // 80
        int result2 = calculator.addNumbers(2165867, 654);  // 21166521
