...
class MyMath {
    ...
    //      > 반환값 유무에 상관없이 반드시 존재! (void 타입에서는 생략되어있음)
    ...
    String yesReturn() {
        String name = "김영경";
        return name;
        // : 반환 타입이 void가 아닌 경우 반드시 해당 타입의 값이 return 뒤에 작성되어야 함!
    }
...
public class Method03 {
    public static void main(String[] args) {
        ...
        // cf) 인자값과 매개변수의 관계
        //      : 자바는 값에 의한 호출 방식을 사용
        //      - 메서드 호출 시 인자값이 "매개변수에 복사"되어 전달됨

        // System.out.println(myMath.divide(10, 0)); // ArithmeticException / by zero
