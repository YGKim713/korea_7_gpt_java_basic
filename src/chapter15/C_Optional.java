...
/*
* === Optional 클래스 ===
* : 값이 존재할 수도 있고 없을수도 있는 객체를 감싸는 컨테이너, 자바 8에서 추가된 기능
...
public class C_Optional {
    public static void main(String[] args) {
        ...
        // Optional<String> optional2 = Optional.of(null); >> Error! NullPointerException 발생
        ...
        System.out.println(optional4.isEmpty()); // true
        ...
        // System.out.println(optional3.get()); >> Error! NoSuchElementException

        // 3) 기본값 처리
        // : .orElse() - 값이 없으면 기본값 반환
        // : .orElseGet() - 값이 없으면 함수형 인터페이스로 값을 생성
        // : .orElseThrow() - 값이 없으면 예외를 발생(사용자 지정)

        System.out.println(optional1.orElse("기본값")); // Hello Optional!
        ...
        //      : null 방지에 대한 필수 값은 직접 값을 반환하고 null 여부 확인 하는것이 더 정확

        // * 데이터 베이스에서 데이터 값을 확인할 때 Optional을 사용하는 경우가 있으므로 배움
    }
}
