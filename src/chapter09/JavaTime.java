...
public class JavaTime {
    public static void main(String[] args) {
        ...
        System.out.println(nowDateTime); // 2024-12-05T12:24:12.163534600
        System.out.println(nowDateTime.toLocalDate()); // 2024-12-05
        System.out.println(nowDateTime.toLocalTime()); // 12:24:12.163534600

        // cf) 날짜와 시간 포맷팅(formatting)
        LocalDateTime example = LocalDateTime.now();
        System.out.println(example); // 2024-12-05T12:28:39.550669600
        DateTimeFormatter formatter = DateTimeFormatter.ofPattern("yy-MM-dd HH:mm:ss");
        System.out.println(example.format(formatter)); // 24-12-05 12:28:39
