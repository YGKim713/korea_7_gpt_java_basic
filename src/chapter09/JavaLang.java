...
// - 객체화 해야 메서드를 사용할 수 있음 EX) myClass1.equals()
...
public class JavaLang {
    public static void main(String[] args) {
        ...
        //System.out.println(myClass1.toString()); // chapter09.MyClass@3ac3fd8b
        ...
        System.out.println(message.length()); // 16 - 문자뿐만 아니라 공백, 기호까지 포함
        ...
        System.out.println(message); // Merry Christmas! - 문자열은 "불변(immutable)" 타입
