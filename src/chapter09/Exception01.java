...
// cf) 컴파일 시점 VS 런타임 시점
// - 컴파일: 소스 코드를 기계어로 번역하는 단계, 실행되지 않고 코드를 분석하고 변환하는 과정에만 국한 (실행 이전)
...
//      at chapter09.Exception01.main(Exception01.java:52)
        ...
        System.out.println("================================");
        try { // 예외 발생 시, 실행 중단 >> 즉, 10/0 에서 예외가 발생하면 numbers[10] = 50; 실행 X
            ...
            // cf) 예외 발생 여부와 상관 없이 항상 실행되는 코드 블럭
            // >> 예외 발생 여부와 상관 없이 무조건 실행 시켜야 하는 코드 입력
