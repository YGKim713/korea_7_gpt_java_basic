...
public class StudentManagementApp {
    ...
    public static void main(String[] args) {
        ...
        //studentList.add(student4); // 인스턴스 메서드 사용 예시
        // 위를 좀 더 간략히 할 수 있다. Student student1 = new Student >> addStudent // static 메서드 사용 예시
    ...
    //      : 메인 클래스 안에서!! main 메서드 내부에 다른 메서드를 호출하려면 해당 메서드는 static이어야 함!
