...
public class C_Conversion {
    public static void main(String[] args) {
        ...
        // 작은 범위의 타입을 큰 범위의 타입에 넣을 때는 컴파일러가 자동으로 형 변환을 수행
        bigBox = smallBox;
        ...
        int number2 = (int)fNumber2; // 실수형을 정수형으로 바꿀 시, 소수점자리 수는 버려진다.

        System.out.println(number2);

        // cf) char 자료형의 형 변환
        char a1 = 'a';
        char a2 = 97;  // 아스키코드 값 (10진수)
        char a3 = '\u0061';  // 유니코드 값 (16진수)
        ...
        long longType = 123456L;
        int intType = (int)longType;
        short shortType = (short)intType;
        char charType = (char)shortType; // 같은 2바이트 이긴 하지만, 자료형이 바뀌는 경우에는 명시적으로
