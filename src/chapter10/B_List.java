...
// 새 책을 책장의 중간에 추가할 경우 - 책을 모두 한 칸씩 옮겨야 함 (시간이 오래걸림)
...
public class B_List {
    public static void main(String[] args) {
        ...
        // 데이터 수정 - 요소를 찾아 변경 >> 인덱스값이 변하지 않기 때문에 성능이 저하되지 않음
        ...
        // 데이터 추가 >> 각 인덱스값이 중요한 것이 아닌, 각 요소간의 연결이 중요하기 때문에, 삽입/삭제 용이
        ...
        System.out.println("리스트에 Orange 포함? " + linkedList.contains("Strawberry")); // false
