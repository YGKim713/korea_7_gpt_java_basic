...
// 2. LinkedHashMap
// : HashMap + 삽입 순서 유지 >> index 값이 중요한게 아니라 요소간의 연결이 중요
...
public class E_Map {
    public static void main(String[] args) {
        ...
        // remove(Object key): 주어진 키와 연관된 '키-값' 쌍 삭제 후 해당 키의 '값'으로 반환
        ...
        Integer integer = students.remove("이승아");
        System.out.println(students); // {김명진=70, 이도경=60}
        System.out.println(integer); // 50
        ...
        // : List 인터페이스의 구현체로 변환
        List<Integer> listAge = new ArrayList<>(ages);
        System.out.println(listAge); // [70, 60]
    }
}
