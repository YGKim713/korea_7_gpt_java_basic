...
public class ObjectPractice2_teacher {
    public static void main(String[] args) {
        Person_ person = new Person_("홍길동", 25);
        new Person_(); // 홍길동 Person 객체 + 선언하지 않은 Person 객체 population = 2

        person.introduce_(); // 안녕하세요, 저는 홍길동이고, 25살입니다.

        System.out.println(Person_.population); // 2
    }
}
