...
class Car {
    ...
    Car(String modelName, int year) {
        ...
        this.year = year; // this가 없으면 생성자의 year인지, 클래스의 year인지 인식 불가
                            // 변수명을 서로 다르게 하면 this를 붙이지 않아도 됨
                            // but, 변수명은 직관적으로 잘 생성해야 하기 때문에 중복될 가능성이 높음
                            // ** 따라서, 위의 model=modelName 보다 this.year=year 형식을 더 많이 사용한다. **
    }
}
