...
class 종달새 implements Flyable {
    public void fly() {
        System.out.println("종달새의 최대 속력은 " + AVERAGE_SPEED + "km의 평균속도보다 느립니다.");
    }
...
class 매 implements Flyable {
    public void fly() {
        System.out.println("매의 최대 속력은 " + AVERAGE_SPEED + "km의 평균속도보다 빠릅니다.");
    }
...
public class Interface02 {
    public static void main(String[] args) {
        ...
        bird1.fly(); // 매의 최대 속력은 100km의 평균속도보다 빠릅니다.
        bird1.land(); // 슈우우웅

        종달새 bird2 = new 종달새();

        bird2.fly(); // 종달새의 최대 속력은 100km의 평균속도보다 느립니다.
        bird2.land(); // 사뿐
