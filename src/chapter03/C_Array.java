...
public class C_Array {
    public static void main(String[] args) {
        ...
        System.out.println(numbers); // [I@3ac3fd8b (주소값)
        System.out.println(Arrays.toString(numbers)); // [1, 2, 3, 4, 5]

        // == 3. 배열 내 검색 ==
        // Arrays.binarySearch(배열, 검색내용);
        // : 존재 O (존재하는 요소의 인덱스 번호 반환)
        // : 존재 X (음수 반환)  >> 인덱스 번호는 0부터 시작, 즉 음수가 존재하지 않음
        System.out.println(Arrays.binarySearch(numbers, 1)); // 0
        System.out.println(Arrays.binarySearch(numbers, 6)); // 음수
