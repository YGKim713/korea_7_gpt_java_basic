...
class Book {
    ...
    Book(String title, String author) {
        this.title = title;
        this.author = author;
        // isAvailable = true;  -  private boolean isAvailable = true; 해당 문장과 같은 역할을 함
    }
...
class Ebook extends Book {
    // There is no parameterless constructor available in 'chapter07.Book' - Error
//     EBook() {
//          super();  // Book 클래스에 기본 생성자가 없기 때문에 super로 가져오는 기본 생성자가 없음
//     }              // 하지만 굳이 Book에 빈 생성자를 만들지 않고 밑의 방식으로 해도 됨
