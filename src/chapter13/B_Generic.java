...
class Basket<T> {
    ...
    public static void printBasket(Basket<?> basket) { // static 타입이기 때문에 변수를 T로 지정하지 않고 ?로 처리
...
public class B_Generic {
    public static void main(String[] args) {
        ...
        System.out.println(integerBasket.getItem()); // 123

        Basket.printBasket(stringBasket); // 바구니의 과일은 사과 입니다.
        Basket.printBasket(integerBasket); // 바구니의 과일은 123 입니다.
        ...
        m1 = new Message<>();
        m1.getMessage(); // Object 타입의 Message 클래스를 사용, 어떤 값으로든 치환 가능
        ...
        // == 상한 제한 와일드 카드 == //
        // <? extends Type>
        // : 특정 타입 또는 그 하위 타입만 허용 >> 일반적인 경우 <? extends Object> 가 생략되어있는 형태
        List<? extends Number> list2 = new ArrayList<Integer>();
     // List<? extends Number> list1 = new ArrayList<Object>(); // Object가 더 상위 타입
