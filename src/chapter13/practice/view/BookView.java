...
public class BookView {
    ...
    public Book getBookDetails() {
        ...
        // cf) 문자열 메서드 - 문자열.trim()
        //      : 문자열 양 끝의 공백을 제거
        String title = scanner.nextLine().trim(); // 메서드 체인 ( 서로 연결 가능 )
    ...
    public void displayBooks(List<Book> books) { // 도서 전체 조회
        if (books.isEmpty()) {
    ...
    public void displayBook(Book book) { // 도서 단권 조회
        if (book == null) {
