...
class Pizza { // 5가지 필수값 생성
    private final String menu; // 종류
    private final String size; // 크기

    private final boolean cheese; // 치즈 선택
    private final boolean mushrooms; // 버섯 선택
...
//  }   >> 생성자로 모두 호출해야함. cheese 등 선택사항도 모두 일일히 선택해야함
    ...
    public static class Builder {
        ...
        private boolean cheese = false; // 치즈 선택
        private boolean mushrooms = false; // 버섯 선택
