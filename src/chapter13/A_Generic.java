...
class Pair<K, V> {
    ...
    // 제네릭 메서드
    // (접근제한자 static) <제네릭타입> 반환타입 메서드명(매개변수...) {}
    // : 메서드 호출 시 전달된 타입에 따라 T가 결정됨
    static <T>void print(T value) {
        System.out.println(value);
    }

    // cf) 타입 변수
    //      Type의 앞글자를 따서 <T> 형식을 주로 사용 (그 다음은 u, v, ...)
}
...
public class A_Generic {
    public static void main(String[] args) {
        ...
        Pair pair = new Pair("안녕하세요", 123); // key - String, value - int 로 자동 유추
