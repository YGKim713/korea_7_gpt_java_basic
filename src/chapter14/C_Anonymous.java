...
@AllArgsConstructor // 생성자로 setter 대체 (수정을 따로 안할 것이기 때문)
@Getter
class Student {
    private String name;
    private int score;
...
public class C_Anonymous {
    public static void main(String[] args) {
        ...
        Student student2 = new Student("김다정", 94);
        Student student3 = new Student("현유상", 58);
        Student student4 = new Student("이은우", 70);
        Student student5 = new Student("윤안나", 63);
