...
// 자바의 함수형 인터페이스를 보관하고 있는 패키지 : import java.util.function.*
...
public class E_Lambda {
    public static void main(String[] args) {
        ...
        // : 해당 람다 내에서 다양한 타입 활용
        Predicate<Integer> isEven = n -> n % 2 == 0; // 논리형태의 문장
        ...
        combinedConsumer.accept("안녕하세요 :)"); // 안녕하세요 :)
                                                     // 8

        // === Supplier === //
        Supplier<Double> randomValue = () -> Math.random(); // 0.0과 0.1 사이의 난수
        System.out.println(randomValue.get()); // 0.8549636420578615
