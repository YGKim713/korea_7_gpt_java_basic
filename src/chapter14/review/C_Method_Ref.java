...
public class C_Method_Ref {
    public static void main(String[] args) {
        ...
        // cf) BiFunction: 두 개의 인자를 받고 힌 개의 객체를 리턴시키는 함수형 인터페이스
        //      BiFunction<T, U, R>
        ...
        // 4. 생성자 참조 예시
        Supplier<Human> humanSupplier = Human::new; // 생성자 호출 >> 하나의 인스턴스가 생성됨
        Human human1 = humanSupplier.get();         // new Human();   과 동일!
