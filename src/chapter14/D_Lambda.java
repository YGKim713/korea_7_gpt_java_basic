...
// : 함수형 인터페이스 구현에 사용, 자바 8 버전 이상부터 도입된 기능
// - 간결성, 함수형 프로그래밍의 지원 등의 특징
// - 익명 클래스를 대체하여 코드의 가독성 향상에 기여

// cf) 함수형 인터페이스
//      : 단 하나의 추상 메서드만 가지는 인터페이스
//      : @FunctionalInterface 어노테이션 (하나의 인터페이스에 여러 추상 메서드 작성을 방지할 수 있음)
...
public class D_Lambda {
    public static void main(String[] args) {
        ...
        System.out.println("익명 클래스로 calculator 구현 결과: " + calculator.add(3, 5)); // 익명 클래스로 calculator 구현 결과: 8
        ...
        // 2) 매개변수가 없는 방식
        NoParams noParams = () -> System.out.println("안녕하세요. 매개변수 읍서요.");
        noParams.sayHello(); // 안녕하세요. 매개변수 읍서요

        // 3) 매개변수가 한 개인 경우 >> 소괄호 생략 가능
        OneParam oneParam = message -> System.out.println("매개변수가 한 개");
