...
public class UserService {
    public static User signUp(UserSignUpRequestDto dto) {
        ...
        if (!password.equals(passwordCheck)) { // 비밀번호 확인 검증 절차
    ...
    public static void main(String[] args) {
        ...
        User user1 = UserService.signUp(dto1);
        System.out.println(user1.getSignUpDate()); // Thu Dec 12 12:06:19 KST 2024
